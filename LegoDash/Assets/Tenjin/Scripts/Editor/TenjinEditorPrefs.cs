...
namespace Tenjin
{
    class TenjinEditorPrefs : IPreprocessBuildWithReport
    {
        ...
        private static void UpdateIronSource()
        {
            ...
            UpdateDefines(tenjin_ironsource, legacyFound, new[] { BuildTargetGroup.iOS, BuildTargetGroup.Android });
            UpdateDefines(tenjin_ironsource_legacy, legacyFound, new[] { BuildTargetGroup.iOS, BuildTargetGroup.Android });
            ...
            UpdateDefines(tenjin_ironsource_levelplay, TypeExists(ironsourceLevelPlayTypes), new[] { BuildTargetGroup.iOS, BuildTargetGroup.Android });
        }
